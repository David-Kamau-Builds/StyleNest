    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            if (promoType == "NEW") {
                ...
                tvBadge.text = "NEW"
                tvBadge.setBackgroundColor(root.context.getColor(com.app.stylenest.R.color.black))
            ...
            if (isFav) {
                ivFavorite.setColorFilter(android.graphics.Color.RED, android.graphics.PorterDuff.Mode.SRC_IN)
            } else {
                ...
                ivFavorite.setColorFilter(heartOffColor, android.graphics.PorterDuff.Mode.SRC_IN)
            }
